...
# 一个人做自媒体怎么起号？选题到复盘的闭环一次讲清

你一个人做自媒体，最容易把时间砸在一件错事上：一上来就把内容打磨到满分——写得很深，资料查得很全，结构改了三遍，结果发出去阅读量个位数。起号前期你真正要先解决的，不是「写得够不够好」，而是「有没有人愿意点进来」。这篇把选题、标题、封面、发布、复盘一条线讲完，照着就能搭出自己的增长闭环。

## 工作流全景

你先看这张图，心里有个数：从趋势和评论进来，到选题池、事实包、标题结构，再变成各平台内容、封面分镜，过一遍合规体检，发布后数据回流，又回到选题池——它是一个转起来的圈，不是一条直线。你顺着这个圈走，就不会再东做一点西做一点。下面用几个具体工作现场说明，你照着做。
...
Skill 的作用是补上其中一个环节，不是接管你账号的判断。下面用几个具体工作现场说明。

## 场景一：每天刷热点，仍然不知道账号该写什么

热榜告诉你「大家正在看什么」，却不告诉你「这个账号为什么值得写」。你只跟热点容易同质化，只凭感觉又难判断用户是否真的关心。
...
你让 WorkBuddy 先生成跨平台样本表，再把评论聚成问题簇，再把「热度、账号匹配、新增价值、证据充足度、制作成本」分别评分，交付一张可以人工删选的选题看板。

![选题看板：热度、匹配度、成本多维度评分](/workbuddy/case-self-media/assets/002_image_UsfnbdO18o.png)

### 还要会找“低粉爆款”

起号要找低粉爆款去抄选题（抄选题，不是原封不动抄内容）。你还可以试试 [viral-topic](https://github.com/kangarooking/kangarooking-skills/tree/main/viral-topic) skill：获取各平台近期指定领域的低粉爆款内容，比如「公众号最近 7 天的 AI 领域低粉爆款文章」，也支持 X 和 YouTube。

![viral-topic：抓取各平台低粉爆款内容](/workbuddy/case-self-media/assets/003_image_D9dBbor45o.png)

## 场景二：想要爆款标题，但不想标题党

「给我 20 个爆款标题」很容易得到数字、悬念和夸张承诺，却没有一个标题能准确兑现正文。标题不是独立文案，它是读者与正文之间的一份承诺。你给的标题，必须能在正文里找到落点。
...
**验收方法**：把标题单独给一个不了解正文的人看，请他写出「我预计点进去会得到什么」，再与正文核对——预期与实际不一致，标题分数再高也不能用。你做 A/B 测试一次只改变一个主要变量，否则数据无法解释。

## 场景三：公众号封面每次从空白画布开始

你直接说「做一张高级感封面」，通常得到与正文无关的装饰图、错误文字或失真的 Logo。你封面得从 brief 开始，先把构图想清楚。
...
公众号文章改小红书，你常见做法是截短段落、加表情符号、铺到九张卡片上——结果信息很多，但封面没有钩子，第二页没有承接，收尾页没有行动。你正确做法是先抽事实包，再设计滑动节奏：

1. 从长文提取不带平台语气的事实包；
2. 选择一个核心问题，删除与它无关的支线；
3. 设计「封面承诺 → 问题共鸣 → 方法 → 示例 → 误区 → 清单」的滑动节奏；
4. 你先输出逐页线框和字数，再生成图片；
5. 你在真实手机宽度检查字号、断行、边距；
...
「改成 60 秒口播」通常只是把文章压缩成更快的朗读稿，没有镜头、节奏、证据画面和停顿。你把它改成真人口播时间轴，别让 AI 替你偷懒。
...
检查整体内容的 AI 味，并降低 AI 味，再把文章排版。
```

你发布链建议停在草稿箱：事实检查 → 引用与版权 → 品牌与合规 → 链接检查 → 手机预览 → 你确认账号 → 发布。自动点赞、批量私信、刷评论、绕过平台风控，不属于该用的效率场景。你拿不准时记住：这些都不在推荐范围内。

## 场景七：发布后不复盘，下一篇仍从零开始

你复盘的核心是把 AI 初稿和人工修改后的终稿对比，让 Skill 自动进化，下一次它写得离期望更近。你可用[公众号写作自我迭代](https://skillhub.cn/skills/skill-article-evolution)或小红书运营副驾，把人工修改和数据写回风格库：
...
**起号期该把精力放在哪？**
你先把「有人愿意点进来」解决掉，也就是选题和标题。内容打磨到满分但没人点，是起号期最亏的事。等点击稳了，再打磨深度。

**低粉爆款能直接抄吗？**
你能抄的是选题角度，不是原封不动抄内容。用 viral-topic 这类 Skill 抓低粉爆款，看的是「什么话题在小号也能爆」，而不是照搬别人的稿。

**标题怎么才算不标题党？**
你让生成器只根据正文已出现的事实出题，并且每个标题都标出「正文哪一段能兑现」。兑现不了的，分数再高也别用。

**小红书九宫格是不是把长文切九张图就行？**
不行。你按场景四的六步走：先抽事实包，再设计封面承诺、问题共鸣、方法、示例、误区、清单的滑动节奏，收尾才生成图片，不然信息很满却没人看完。

**发布环节能全交给自动化吗？**
建议停在草稿箱。事实、版权、合规、链接、手机预览这些确认过，再发。自动点赞、刷评论、绕过风控这些，不在推荐范围内。

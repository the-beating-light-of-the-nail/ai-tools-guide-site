...
可用 Skill：[灵感捕手](https://skillhub.cn/skills/inspiration-hunter-skill)（自动分类并写入 Markdown 收件箱）、[ima-skills](https://skillhub.cn/skills/ima-skills)（移动端记录、知识库读写与检索）；Obsidian 本地目录作为长期主版本时，可接入 Wiki 类 Skill。
...
可用 Skill：[Obsidian 资料整理](https://skillhub.cn/skills/obsidian-core-notes)（维护核心笔记、专题综合和目录链接）、[agent + Obsidian 长期记忆](https://skillhub.cn/skills/obsidian-memory)（在明确项目边界后读写长期记忆）。

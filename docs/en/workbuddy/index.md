...
```mermaid
flowchart LR
    A[Install & sign in] --> B[Interface & first task]
    B --> C[Skills & Experts]
    C --> D[Connectors / IM assistant / automation]
    D --> E[Hands-on case studies]
    E --> F[Advanced: building Skills, multi-agent, reliability]
```

...
| --- | --- | --- |
| WorkBuddy | [AlephAITech/WorkBuddyGuide](https://github.com/AlephAITech/WorkBuddyGuide), *The WorkBuddy Practical Handbook* (MIT) | A curated adaptation of its user guide chapters (including skills, the IM assistant, external APIs, and further reading), 5 case-study chapters, 3 advanced chapters, and the quick-reference appendix — 21 articles in total |
...
Spotted an error or something out of date? Let us know — and if you can include a link to the relevant official documentation, even better. We'll follow up and update.

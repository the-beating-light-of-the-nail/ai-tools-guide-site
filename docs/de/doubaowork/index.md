...
```mermaid
flowchart LR
    A[Installation und Anmeldung] --> B[Oberfläche und erste Aufgabe]
    B --> C[Konnektoren und Skills]
    C --> D[Smartphone-Fernsteuerung / Geplante Aufgaben]
    D --> E[Praxisfälle nach Szenario]
    E --> F[Fortgeschritten: Arbeitspartner, Squads und Multi-Agent]
```

...
```mermaid
flowchart LR
    A[Installation & Anmeldung] --> B[Oberfläche und erste Aufgabe]
    B --> C[Skills und Experten]
    C --> D[Konnektoren / IM-Assistent / Automatisierung]
    D --> E[Praxisfallbeispiele]
    E --> F[Fortgeschritten: Skills bauen, Multi-Agent, Zuverlässigkeit]
```

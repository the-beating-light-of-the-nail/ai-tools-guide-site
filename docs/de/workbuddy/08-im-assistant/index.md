...
![Mini-Programm-Einstieg für Lokal- und Cloud-Modus](/workbuddy/08-im-assistant/assets/001_image_Vv5bbtLVBo.png)
...
![Zahnrad in der Assistenten-Leiste öffnet die Einstellungen](/workbuddy/08-im-assistant/assets/002_微信助理-进入助理设置_NbI2b9v4fo.png)

2. Suchen Sie „WeChat-Assistent-Integration" und klicken Sie auf „Konfigurieren";

![Bei WeChat-Assistent-Integration auf Konfigurieren klicken, fr: Cliquer sur Configurer dans l'intégration Assistant WeChat](/workbuddy/08-im-assistant/assets/003_微信助理-选择集成_S9HlbaEmdo.png)

3. Warten Sie, bis der Bindungs-QR-Code erzeugt wird, und scannen Sie ihn mit WeChat am Smartphone;

![Bindung durch Scannen des QR-Codes mit WeChat](/workbuddy/08-im-assistant/assets/004_微信助理-扫码绑定_TElmbNPG5o.png)

4. Sobald die Karte „Gebunden" anzeigt, senden Sie zuerst einen schreibgeschützten Testbefehl;

![Karte zeigt Gebunden; schreibgeschützten Testbefehl senden, fr: Carte « Lié » ; envoi d'une commande de test en lecture seule](/workbuddy/08-im-assistant/assets/005_微信助理-已绑定_ZQtrb6jCmo.png)
...
![Feishu in den Assistenten-Einstellungen wählen](/workbuddy/08-im-assistant/assets/006_image_SbcEbSaoio.png)

2. Auf der Feishu Open Platform eine unternehmensinterne Eigenbau-App anlegen;

![Eigenbau-App auf der Feishu-Open-Plattform anlegen](/workbuddy/08-im-assistant/assets/007_飞书-登录开放平台_EUPhblavHo.png)

3. Der App Bot-Fähigkeiten hinzufügen;

![Dem Feishu-App Bot-Fähigkeit hinzufügen](/workbuddy/08-im-assistant/assets/008_飞书-添加机器人能力_XFmTb5HGQo.png)

4. Gemäß den Angaben der aktuellen WorkBuddy-Seite minimal benötigte Berechtigungen freischalten;

![Nur die geforderten Minimalrechte freigeben](/workbuddy/08-im-assistant/assets/009_飞书-批量导入权限_MRdCbm3Dvo.png)

5. Unter „Zugangsdaten und Grundinformationen" App ID und App Secret abrufen;

![App-ID und Secret unter Anmeldedaten & Grunddaten holen, fr: Récupérer l'App ID et le Secret dans « Identifiants »](/workbuddy/08-im-assistant/assets/010_飞书-应用凭证_CnItbspOUo.png)

6. Die Zugangsdaten in WorkBuddy eintragen und Callback-Informationen erzeugen bzw. kopieren;

![Anmeldedaten in WorkBuddy eintragen und Callback erzeugen](/workbuddy/08-im-assistant/assets/011_飞书-加密与校验配置_WiAYbwBDKo.png)
...
![Feishu-Ereignisabonnement: Nachrichten-Ereignis hinzufügen](/workbuddy/08-im-assistant/assets/012_飞书-添加接收消息事件_X4z6bNPsso.png)

![Card-Interaktions-Callback in Feishu konfigurieren](/workbuddy/08-im-assistant/assets/013_飞书-卡片回调_AvOxbO7M9o.png)

8. Eine Version erstellen und die App veröffentlichen; danach dem Bot in Feishu eine schreibgeschützte Testaufgabe senden.

![Version erstellen und Feishu-App veröffentlichen](/workbuddy/08-im-assistant/assets/014_飞书-发布应用_TafwbySxco.png)

## DingTalk anbinden

![DingTalk-Einrichtung: App-Entwicklung und Bot-Einstieg](/workbuddy/08-im-assistant/assets/015_image_RRhMbPo5uo.png)
...
![App in der DingTalk-Entwicklerkonsole anlegen](/workbuddy/08-im-assistant/assets/016_钉钉-创建应用_NuNTbdscZo.png)
...
![Bot-Fähigkeit in DingTalk hinzufügen und veröffentlichen](/workbuddy/08-im-assistant/assets/017_钉钉-添加机器人能力_ORRbbZrqgo.png)

3. Schalten Sie die benötigten Berechtigungen frei;

![Benötigte DingTalk-App-Rechte freigeben](/workbuddy/08-im-assistant/assets/018_钉钉-开通权限_QG1zbPhcxo.png)
...
![DingTalk-Anmeldedaten holen und in WorkBuddy eintragen](/workbuddy/08-im-assistant/assets/019_钉钉-获取应用凭证_OI8fbW0JNo.png)

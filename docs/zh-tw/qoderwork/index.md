...
### 上手篇：先把 QoderWork 用起來

| 章節 | 你會得到什麼 |
| --- | --- |
| [QoderWork 是什麼](/zh-tw/qoderwork/01-what-is) | 八大能力、三個核心概念、與 Qoder/國內版的關係 |
| [安裝與登入](/zh-tw/qoderwork/02-install) | 雙平臺安裝、選對安裝包、積分與隱私 |
| [第一個任務](/zh-tw/qoderwork/03-first-task) | 描述→監控→產物的完整迴圈 + 模型選擇 |
| [工作資料夾](/zh-tw/qoderwork/04-files) | 讓 AI 直接讀寫本地檔案（核心玩法） |
...
| 章節 | 你會得到什麼 |
| --- | --- |
| [電腦操控、語音輸入與應用快照](/zh-tw/qoderwork/adv-computer-use) | 讓 AI 碰你的鍵鼠螢幕 + 快捷鍵表 |
| [對話式建立技能](/zh-tw/qoderwork/adv-skill-create) | /create-skill 實戰與質量清單 |
| [三大工作臺](/zh-tw/qoderwork/adv-workbenches) | 設計 / 幻燈片 / 寫作的垂類打法 |
| [意識、成本與安全環境](/zh-tw/qoderwork/adv-memory-cost) | 讓 AI 記住你 + Credits 省錢法 |
...
- 下載：[qoderwork.com](https://qoderwork.com) ｜ 國內版 [qoder.com.cn](https://qoder.com.cn/qoderwork)

...
先刪除安裝包並從官網重新下載，核對系統和晶片版本。仍失敗時記錄系統版本、安裝包名和報錯截圖，透過官方回饋渠道處理，不要隨意關閉系統安全功能。
...
確認任務選擇的工作目錄是否正確、系統是否授予對應目錄權限、檔案是否被其他程式鎖定。先用一個空白文字檔測試，不要直接拿重要檔案反覆試錯。

### 更新前要不要備份

應用更新一般不應修改工作檔案，但長期項目仍應把輸入、產物、設定和自訂 Skill 納入版本管理或定期備份。
